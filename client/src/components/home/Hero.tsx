    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 text-center px-5 sm:px-6 max-w-5xl mx-auto w-full">
        <motion.p
          ...
          className="text-[10px] sm:text-xs font-medium uppercase tracking-[0.3em] sm:tracking-[0.4em] text-gray-300 mb-4 sm:mb-6"
        >
        ...
        <motion.h1
          ...
          className="text-[clamp(3rem,14vw,10rem)] font-black uppercase tracking-[-0.04em] sm:tracking-[-0.05em] mb-6 sm:mb-8 leading-[0.85] italic"
        >
          Redefine <br />
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm md:text-base font-light mb-8 sm:mb-12 tracking-wider text-gray-300 max-w-sm sm:max-w-lg mx-auto leading-relaxed"
        >
        ...
        >
          <a
            href="/products"
            className="group relative w-full sm:w-auto px-8 sm:px-12 py-4 sm:py-5 bg-white text-black text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.25em] overflow-hidden transition-all duration-300"
          >
          ...
          <a
            ...
            className="w-full sm:w-auto px-8 sm:px-12 py-4 sm:py-5 border border-white/30 text-xs font-black uppercase tracking-[0.2em] sm:tracking-[0.25em] text-white hover:bg-white hover:text-black transition-all duration-300 backdrop-blur-sm text-center"
          >
            New Arrivals
          </a>
        </motion.div>
