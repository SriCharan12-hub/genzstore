      ...
      <div className="w-full max-w-sm sm:max-w-md">
        <div className="bg-white p-6 sm:p-10 border border-gray-100 shadow-sm">
          ...
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h1 className="text-xl sm:text-2xl font-black uppercase tracking-tight mb-1.5">Create Account</h1>
            <p className="text-xs text-gray-400 uppercase tracking-wider">Join our community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
            ...
            <div>
              <label className="text-[10px] font-bold uppercase tracking-wider text-gray-500 block mb-1.5">Confirm Password</label>
              <div className="relative">
                <input
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-black text-white text-xs font-bold uppercase tracking-[0.15em] py-4 hover:bg-gray-900 disabled:bg-gray-300 transition-colors mt-1"
            >
